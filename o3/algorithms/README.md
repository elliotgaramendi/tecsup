# [💻 Algorithms and Data Structures 💻](https://github.com/elliotgaramendi/tecsup/tree/develop/o3/algorithms)
...
1. 📥 **Descarga e instala [Python](https://www.python.org/downloads/) o el lenguaje requerido**.
2. 🛠️ **Instala un entorno de desarrollo** como [Visual Studio Code](https://code.visualstudio.com/) o [PyCharm](https://www.jetbrains.com/pycharm/).
3. 🔧 **Configura el entorno:**
   - Instala las extensiones necesarias.
   - Ejecuta los códigos desarrollados en los laboratorios.
...
- 🛠️ **Dibuja diagramas de flujo y escribe pseudocódigo** antes de codificar.
- 🎯 **Practica resolviendo problemas** y desafíos de programación.
- 🐙 **Crea un portafolio en GitHub** para mostrar tu progreso y proyectos.
- 📚 **Consulta la bibliografía recomendada** para reforzar tu aprendizaje.

## 🎯 Contenido del Curso 🎯

1. **Introducción a los Algoritmos y Diagramas de Flujo**
2. **Recursión y Backtracking**
3. **Listas Enlazadas**
4. **Pilas y Colas**
5. **Búsqueda y Ordenamiento**
6. **Árboles y Árboles Binarios de Búsqueda**
7. **Grafos**
8. **Algoritmos de optimización en grafos**
9. **Tablas Hash y Algoritmos de Hashing**
10. **Heap y Heap Sort**
11. **Proyecto Final**
